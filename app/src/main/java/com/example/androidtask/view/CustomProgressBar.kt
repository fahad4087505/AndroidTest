package com.example.colepower.view
...
class CustomProgressBar {
    ...
    fun show(context: Context, title:CharSequence?): Dialog {
        ...
        val view = inflator.inflate(R.layout.progress_layout, null)
        if (title != null) {
        ...
        setColorFilter(view.cp_pbar.indeterminateDrawable,ResourcesCompat.getColor(context.resources,
            R.color.white, null)) //Progress Bar Color
